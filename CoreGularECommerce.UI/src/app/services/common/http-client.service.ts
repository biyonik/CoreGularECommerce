...
export class HttpClientService {
  ...
  delete<T>(requestParameters: Partial<RequestParameters>, body: Partial<T>): Observable<T> {
    let url: string = '';
    if (requestParameters.fullEndPoint) {
      url = requestParameters.fullEndPoint;
    } else {
    ...
    return this.httpClient.delete<T>(url, {headers: requestParameters.headers, body: body});
  }
}
